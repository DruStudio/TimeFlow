...
try {
  ...
  console.log('TimeFlow will initialize on DOM ready');
}
...
// Ensure timeFlow is available globally
...
function initHomePage() {
  // Ensure timeFlow is initialized
  if (!timeFlow) {
    timeFlow = new TimeFlow();
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Export for use in inline scripts and visualizations
  window.TimeFlow = TimeFlow;
  window.timeFlow = timeFlow;
